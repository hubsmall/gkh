...
<div class="wrapper">
    <div class="panel-body"> 
        <div class="form-group">
            ...
            <label class="control-label col-sm-3" for="unitSearch">Unit</label>
            <div class="col-sm-3">
                <select class="custom-select mr-sm-2" id="unitSearch">
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-3">
                <button type="submit" class="btn btn-default search">
                    <i class="fa fa-plus">Search serve</i>
                </button>             
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">                    
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="custom-select mr-sm-2 inputValidation" id="U">
                                <option selected="" value="">choose</option>
                                <option  value="m^2">m^2</option>
                                <option value="kilovatt">kilovatt</option>
                                <option value="m^3">m^3</option>
